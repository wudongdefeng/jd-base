...
function Combin_All {
  ...
  if [[ $(date -u "+%H") -eq 12 ]] || [[ $(date -u "+%H") -eq 13 ]]; then
    export NEWYEARMONEY_SHARECODES=$(Combin_Sub ForOtherNEWYEARMONEY "usNvD7MW94leAuMyN7g8s3c2i1OvK5YccxC_RiJ23Ip-6w@oMZeXLca9otVAeNgNrIk_GZu-8hHEOI3tbbj_g52x6MCo4S8@oMZePJQpycElYL5CTOYKswMDM5KxTKb4tqqe9VblYNI0TRY")
  else
