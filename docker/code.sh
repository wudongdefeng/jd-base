...
repo1='dancing-wind_jingdong'                       #预设的 dancing-wind_jingdong仓库
repo2='wudongdefeng_tem-update'                               #预设的 he1pu 仓库    
repo3='smiek2221_scripts'                               #预设的 Hyominn_hyominnn2 仓库
repo4=''#预设的 shufflewzc 仓库
repo5='curtinlv_JD-Script_main'#预设的 py 仓库，用于读取口袋书店互助码。需提前拉取温某人的仓库或口袋书店脚本并完整运行。
repo6=''#预设的 Aaron-lv 仓库
repo7=''#预设的 smiek2221 仓库
