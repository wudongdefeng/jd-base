...
# 处理后的log文件
logFile=sharecodeCollection.log
...
#种豆得豆
autoHelp "京东种豆得豆好友互助码" "${logDir}/jd_zero_wind_plantBean.log" "PLANT_BEAN_SHARECODES"
...
#京东赚赚
autoHelp "京东赚赚好友互助码" "${logDir}/jd_kingran_wind_jdzz.log" "JDZZ_SHARECODES"
...
#闪购盲盒
autoHelp "闪购盲盒好友互助码" "${logDir}/jd_kingran_wind_sgmh.log" "JDSGMH_SHARECODES"
